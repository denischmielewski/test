...
//BOOST_LOG_ATTRIBUTE_KEYWORD(date_time_attr, "TimeStamp", ptime)
...
int main(int, char*[])
{
    ...
    logging::formatter fmt = expr::stream
        ...
        //<< expr::format_date_time< boost::posix_time::ptime >("TimeStamp", "%Y-%m-%d %H:%M:%S:%f : ") //works fine, standard way from boost log doc
        << expr::smessage;
